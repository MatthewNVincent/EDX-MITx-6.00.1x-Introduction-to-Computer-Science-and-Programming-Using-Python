...
WORDLIST_FILENAME = "D:\Dropbox\Programming\Git\MITx 6.00.1x Introduction to Computer Science and Programming Using Python\Problem Set 03\words.txt"
...
def isWordGuessed(secretWord, lettersGuessed):
    ...
    if num_of_guessed_letters == len(secretWord):
        return True
    else:
        return False
